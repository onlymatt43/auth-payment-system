        ...
        <div className="space-y-8">
          ...
          <section className="neon-border-yellow glass-dark rounded-3xl p-8">
            ...
            <p className="text-gray-300 mb-4">
              En accédant et en utilisant OnlySLUT, vous acceptez de respecter ces conditions d'utilisation. 
              Si vous n'êtes pas d'accord, veuillez cesser d'utiliser notre plateforme.
            </p>
            <p className="text-gray-300">
              OnlySLUT est fourni "tel quel" sans garanties de quelque nature que ce soit, explicites ou implicites.
            </p>
          </section>
          ...
          <section className="neon-border-yellow glass-dark rounded-3xl p-8">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                OnlySLUT n'encourage pas le jeu excessif. Nous avons implémenté des limites de taux pour éviter les abus.
              </p>
          ...
          <section className="neon-border-pink glass-dark rounded-3xl p-8">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                <strong>Méthode de Paiement:</strong> OnlySLUT accepte les paiements via PayPal en mode sandbox (test).
              </p>
              <p>
                <strong>Frais:</strong> Aucun frais supplémentaire n'est facturé en plus des prix affichés. Les frais PayPal 
                sont couverts par OnlySLUT.
              </p>
              <p>
          ...
          <section className="neon-border-yellow glass-dark rounded-3xl p-8">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                OnlySLUT se réserve le droit de suspendre ou de résilier votre compte immédiatement si:
              </p>
              <ul className="space-y-2 text-sm">
          ...
          <section className="neon-border-pink glass-dark rounded-3xl p-8">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                OnlySLUT n'est pas responsable de:
              </p>
              <ul className="space-y-2 text-sm">
          ...
          <section className="neon-border-blue glass-dark rounded-3xl p-8">
            ...
            <p className="text-gray-300">
              OnlySLUT peut modifier ces conditions à tout moment. Les modifications entreront en vigueur dès la publication 
          ...
          <section className="neon-border-yellow glass-dark rounded-3xl p-8">
            ...
            <div className="bg-dark-navy rounded-lg p-4 border border-neon-yellow/30">
              <p><strong>Email:</strong> support@onlyslut.com</p>
